...
export default function GridTextFiled({id, type, label, value, action, actionOnBlur, variant, focused, required, fullWidth, placeholder, error, disabled, inputProps, xs, md, spacing }){
    return (
